...
The main script **main.py** allows a flexible use of this implementation. Here, the user can controll the geometric and mechanical properties of the plaate and define load vectors and boundary conditions using the utility functions given in "Utilities.py". I will keep adding utility functions to include new load and boundary condition scenarios.
